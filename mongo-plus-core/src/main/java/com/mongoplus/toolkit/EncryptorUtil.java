...
import com.mongoplus.encryptor.*;
...
public class EncryptorUtil {
    ...
    public final static Map<AlgorithmEnum, Encryptor> algorithmEnumEncryptorMap = new ConcurrentHashMap<>();

    public final static Map<Class<?>, Encryptor> encryptorCache = new ConcurrentHashMap<>();
    ...
    static {
        ...
        algorithmEnumEncryptorMap.put(AlgorithmEnum.PBEWithMD5AndDES,
                new PBEExample(AlgorithmEnum.PBEWithMD5AndDES.getAlgorithm()));
        algorithmEnumEncryptorMap.put(AlgorithmEnum.PBEWithMD5AndTripleDES,
                new PBEExample(AlgorithmEnum.PBEWithMD5AndTripleDES.getAlgorithm()));
        algorithmEnumEncryptorMap.put(AlgorithmEnum.PBEWithSHA1AndDESede,
                new PBEExample(AlgorithmEnum.PBEWithSHA1AndDESede.getAlgorithm()));
        algorithmEnumEncryptorMap.put(AlgorithmEnum.PBEWithSHA1AndRC2_40,
                new PBEExample(AlgorithmEnum.PBEWithSHA1AndRC2_40.getAlgorithm()));
    }
